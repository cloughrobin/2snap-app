...
//
#define kAPIHost @"http://www.snapduel.com/" //server adress and folder (must be read/write )
#define kAPIPath @"app/"
...
-(NSURL*)urlForTagIcon:(NSNumber*)tagID{
    NSString* urlString = [NSString stringWithFormat:@"%@/%@tag/%@.png", kAPIHost, kAPIPath, tagID];
   NSLog(@"%@",urlString);
